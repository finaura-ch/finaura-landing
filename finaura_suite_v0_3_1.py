...
- Chat (0.2.7) und Finanzplan (0.3.0) bleiben als separate lauffähige Module bestehen.
- Ziel: Pragmatik – wichtigste Funktionen heute sauber gespeichert.
...
```
""")
    st.info("Warum separat? **Stabilität & Pragmatik.** Der Chat ist ein eigenständiges Modul (v0.2.7), das heute bereits monetarisiert ist.")
