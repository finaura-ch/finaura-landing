# FINAURA IK Analyzer — v1.2.1 (2025-10-18, Europe/Zurich)
# CHANGE: Klarere Fehlerhinweise bei nicht erkannten Werten, dezentes Weiß/Blau-Theme, UI-Feinschliff.
...
# Run:        streamlit run finaura_ik_analyzer_v1_2_1.py
#
